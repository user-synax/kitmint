  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-8 animate-fade-in">
      ...
      <Tabs defaultValue="account" className="w-full">
        <TabsList className="bg-[#111111] border border-[#111827] p-1">
          <TabsTrigger value="account" className="data-[state=active]:bg-[#1A1A1A] data-[state=active]:text-primary-text">
            <User className="w-4 h-4 mr-2" />
            Account
          </TabsTrigger>
          <TabsTrigger value="plan" className="data-[state=active]:bg-[#1A1A1A] data-[state=active]:text-primary-text">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-3">
                    <Input 
                      ...
                      className="bg-surface-3 border-border focus:border-primary/50"
                      disabled={isUpdatingName}
                    />
                    <Button type="submit" disabled={isUpdatingName || name === user.name} className="bg-primary hover:bg-primary-hover text-white">
            ...
            <Card className="bg-[#111111] border-border">
              ...
              <CardContent>
                <form onSubmit={handleUpdatePassword} className="space-y-4">
                  ...
                  <Button type="submit" disabled={isUpdatingPassword || !passwords.current || !passwords.new} className="bg-surface-2 border-border text-text-primary hover:bg-surface-3">
                    Update Password
                  </Button>
                </form>
              </CardContent>
          ...
          <Card className="bg-[#111111] border-border overflow-hidden">
            <div className="bg-primary/5 border-b border-primary/10 p-6 flex justify-between items-center">
              <div>
                ...
                <h3 className="text-2xl font-bold text-text-primary capitalize">{user.plan}</h3>
              </div>
            ...
            <CardContent className="p-6 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                {user.plan === 'free' && (
                  <div className="bg-surface-2 border border-border rounded-lg p-5 flex flex-col justify-center relative overflow-hidden">
                    <Badge className="absolute top-3 right-3 bg-primary/20 text-primary-text border-none text-[10px]">COMING SOON</Badge>
